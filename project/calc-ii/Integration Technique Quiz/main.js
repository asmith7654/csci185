...
const questions = [
    {
        ...
        answers: ["1/2ln|x^2+7|+c", "(1/2)ln|x^2+7|+c", "1/2*ln|x^2+7|+c", "(1/2)*ln|x^2+7|+c", "1/2ln(x^2+7)+c", "(1/2)ln(x^2+7)+c", "1/2*ln(x^2+7)+c", "(1/2)*ln(x^2+7)+c", "(1/2)(ln(x^2+7))+c", "1/2(ln(x^2+7))+c", "(1/2)*(ln(x^2+7))+c", "1/2*(ln(x^2+7)+c", "(1/2)(ln|x^2+7|)+c"]
    },
    {
        question: "$$∫ x^{3}e^{x^4}dx$$",
        answers: ["1/4e^x^4+c", "(1/4)e^x^4+c", "1/4*e^x^4+c", "1/4(e^x^4)+c", "(1/4)(e^x^4+c)", "1/4e^(x^4)+c", "(1/4)e^(x^4)+c", "(1/4)(e^(x^4))+c", "1/4(e^(x^4))+c"]
    },
    {
        question: "$$∫ cos(2x)dx$$",
...
//     console.log(answer);
//     document.querySelector('.current-answer').innerHTML = '$'+answer+'$';
//     MathJax.typeset();
// }
